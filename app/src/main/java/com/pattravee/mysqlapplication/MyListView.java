...
public class MyListView extends BaseAdapter {
    ...
    @Override
    public int getCount() { return myTodoList.size(); }

    @Override
    public TodoList getItem(int position) { return myTodoList.get(position); }

    @Override
    public long getItemId(int position) { return myTodoList.get(position).getTaskid(); }
